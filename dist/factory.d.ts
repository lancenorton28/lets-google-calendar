import type { CreateGoogleCalendarOptions, GoogleCalendar, GoogleCalendarConfig, RouterDeps } from "./types";
/**
 ...
 * ```
 */
export declare function createGoogleCalendar(config: GoogleCalendarConfig, deps: RouterDeps, options?: CreateGoogleCalendarOptions): GoogleCalendar;
